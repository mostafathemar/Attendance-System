...
class DoctorHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocProvider(
        create: (BuildContext context) => AppCubit()..getDoctorCourse(),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    cubit.doctorCourses != null ?
                    ConditionalBuilder(
                      condition: state is !GetDoctorCourseLoadingState,
                      builder: (context) => Container(
                        height: fixedHieght*700/fixedHieght,
                        child:  ListView.builder(
                          itemBuilder: (context, index) {
                            print('$LectureId');
                            if (cubit.doctorCourses!=null) {
                         return   InkWell(
                           onTap: (){
                             LectureId=cubit.doctorCourses!.courses![index].id;
                             ...
                             Navigator.of(context).push(MaterialPageRoute(
                                     builder: (context) =>
                                         AllCourses(
                                           ...
                                           courses: cubit.doctorCourses!.courses![index],
                                         )));
                           },
                           child: LectureCard1(
                                  model: cubit.doctorCourses?.courses![index], // Change here
                          ...
                          itemCount: cubit.doctorCourses?.courses!.length,
                        ),
                      ),
